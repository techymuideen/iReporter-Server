...
router
  .route('/')
  .get(protect, restrictTo('user'), userController.getAllUsers)
...
router
  ...
  .patch(protect, userController.uploadUserPhoto, userController.resizeUserPhoto, userController.updateMe )
